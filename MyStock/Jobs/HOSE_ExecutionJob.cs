...
{
    public class HOSE_ExecutionJob : Job
    {
        private readonly string link = "https://trade.vndirect.com.vn/chung-khoan/hose";
        private readonly long idSan = (int)enumSanGD.HOSE;
