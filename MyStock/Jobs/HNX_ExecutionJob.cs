...
{
    public class HNX_ExecutionJob : Job
    {
        private readonly string link = "https://trade.vndirect.com.vn/chung-khoan/hnx";
        private readonly long idSan = (int)enumSanGD.HNX;
